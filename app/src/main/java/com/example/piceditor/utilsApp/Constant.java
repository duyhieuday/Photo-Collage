...
public class Constant {
    ...
    public static String POLICY_URL = "https://sites.google.com/view/eztechapps/home";
...
//    public static final String API_KEY_ACCU = "ekhA5PxPCm3KgNImGcXtjUJqRd4Rt3Cb"; // app 10tr
    ...
    public static class RemoteConfigKey{
        public static final String NATIVE_CLICK_RATE_exit = "native_click_rate_exit";
        ...
        public static final String ADS_EXT = "ads_exit";
        public static final String BANNER_COLL = "banner_coll";
        public static final String BANNER_COL = "banner_collap";
        public static final String TEST_DIALOG = "test_dialog";
        public static final String NATIVE_AFTER_INTER = "n_a_i";
        public static final String TEST_OBD = "test_obd";
        ...
        public static final String CLICK_INTER = "click_inter";
        public static final String NATIVE_DIALOG = "native_dialog";
        public static final String SORT = "sort";
        public static final String IAP = "iap";
        public static final String INTER_AFTER_SET = "inter_after_set";
        public static final String INTER_SPLASH = "inter_splash";
        public static final String NATIVE_FULL_OBD = "native_full_obd";
        public static final String LOAD_OB1 = "load_ob1";
        public static final String BUTTON_APPLY_LANGUAGE = "button_apply_language";
        public static final String HIDE_PREMIUM = "hide_premium";
        public static final String DELAY_INTER = "delay_inter";
        public static final String FIRST_INTER = "first_inter";
        public static final String INTER_FINGER_UP = "inter_finger_up";
        ...
        public static final String OPEN_ID_DEFAULT = "open_id_default";
        public static final String INTER_SPLASH_ID = "inter_splash_id";
        public static final String NATIVE_INTER_FULL = "native_inter_full";
        public static final String NATIVE_LANGUAGE1_ID = "native_language1_id";
        public static final String NATIVE_LANGUAGE2_ID = "native_language2_id";
        public static final String NATIVE_OBD1_ID = "native_obd1_id";
        public static final String NATIVE_OBD3_ID = "native_obd3_id";
    ...
    public static class SharePrefKey {
        ...
        public static final String NATIVE_OBD1_ID = "native_obd1_id";
        public static final String NATIVE_OBD3_ID = "native_obd3_id";
        public static final String NATIVE_OBD_FULL = "native_obd_full";
        public static final String BANNER_SPLASH = "banner_splash";
